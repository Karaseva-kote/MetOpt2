...
public class ConjugateGradientMethod extends AbstractNMethod {
    ...
    public ConjugateGradientMethod(QuadraticFunction fun, int reboot, String name, Vector start) {
        super(fun, name, start);
        this.REBOOT = reboot;
    }

    public ConjugateGradientMethod(QuadraticFunction fun, String name, Vector start) {
        this(fun, fun.getN(), name, start);
    }
