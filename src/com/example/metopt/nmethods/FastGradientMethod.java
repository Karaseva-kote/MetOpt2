...
public class FastGradientMethod extends AbstractNMethod {
    ...
    public FastGradientMethod(QuadraticFunction fun, String name, Vector start) {
        super(fun, name, start);
    }

    public FastGradientMethod(QuadraticFunction func, Vector start) {
        super(func, "Fast gradient descent", start);
    }

    public FastGradientMethod(QuadraticFunction func, Vector start, double eps) {
